...
def increment_path2(path, exist_ok=False, sep='', mkdir=False):
...
def save_one_box(xyxy, im, file=Path('im.jpg'), gain=1, pad=10, square=False, BGR=False, save=True):
    ...
    if save:
        ...
        f = str(increment_path2(file).with_suffix('.jpg'))
